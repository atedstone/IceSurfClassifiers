...
s2 = pd.read_excel('/home/at15963/Dropbox/work/black_and_bloom/multispectral-sensors-comparison.xlsx',
	sheet_name='Sentinel-2')
#wvl_centers = s2.central
s2 = s2[s2['spatial res'] <= 20]
wvls = pd.DataFrame({'low':s2.start, 'high':s2.end})
